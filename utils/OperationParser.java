...
public final class OperationParser {
    ...
    private AbstractOperation parseVcsOperation(String newOperation,
        ...
        case "status":
            return operationFactory.createOperation(OperationType.STATUS,
                    operationArgs);
        case "branch":
            return operationFactory.createOperation(OperationType.BRANCH,
                    operationArgs);
        case "commit":
            return operationFactory.createOperation(OperationType.COMMIT,
                    operationArgs);
        case "checkout":
            return operationFactory.createOperation(OperationType.CHECKOUT,
                    operationArgs);
        case "log":
            return operationFactory.createOperation(OperationType.LOG,
                    operationArgs);
        case "rollback":
            return operationFactory.createOperation(OperationType.ROLLBACK,
                    operationArgs);
        default:
            return operationFactory
                    .createOperation(OperationType.VCS_INVALID_OPERATION,
                            operationArgs);
        }
    }
